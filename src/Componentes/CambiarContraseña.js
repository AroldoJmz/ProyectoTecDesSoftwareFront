...
export default function CambiarContraseña({user}){
    ...
    return(
        <>
        <button className="btn btn-outline-secondary" onClick={openEditPasswordModal} data-bs-toggle="modal" data-bs-target={`#modalPassword${formData.id}`}><FaUserPen/></button>    
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <form autoComplete='off'>
                            <div className="mb-3">
                                <label for="password" className="form-label">Contraseña Nueva</label>
